...
class ChiTietHoaDonBUS extends DB_business
{
    ...
    {
        return $this->remove($this->_table_name, $this->_key . "='" . $id . "' AND " . $this->_key . "='" . $id2 . "'");
    }

    // Hàm cập nhật theo id hóa đơn + id sản phẩm
    function update_by_2id($data, $id, $id2)
    {
        return $this->update($this->_table_name, $data, $this->_key . "='" . $id . "' AND " . $this->_key . "='" . $id2 . "'");
    }

    // hàm select theo id hóa đơn + id sản phẩm
    function select_by_2id($select, $id, $id2)
    {
        $sql = "select $select from " . $this->_table_name . " where " . $this->_key . " = '" . $id . "' AND " . $this->_key . "='" . $id2 . "'";
